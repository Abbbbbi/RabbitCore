...
Only requiring some minor changes is rabbit.cpp.
...
Changes to rabbit.cpp
----------------------
rabbit.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
