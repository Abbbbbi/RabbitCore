...
This mechanism has been integrated into Bitcore-Node-Rabbit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rabbitcoin/insight-api-rabbit#web-socket-api](https://github.com/rabbitcoin/insight-api-rabbit#web-socket-api) 
* API: [https://github.com/rabbitcoin/insight-api-rabbit#instantsend-transactions](https://github.com/rabbitcoin/insight-api-rabbit#instantsend-transactions) 
...
By default, the Rabbit Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rabbit Core daemon:
