...
2. run rabbitd with -printalert or -sendalert like this:
   /path/to/rabbitd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://rabbitcoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Rabbit Core:0.12.0.58/"));
