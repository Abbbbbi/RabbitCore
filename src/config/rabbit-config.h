/* src/config/rabbit-config.h.  Generated from rabbit-config.h.in by configure.  */
/* src/config/rabbit-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RABBIT_CONFIG_H

#define RABBIT_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Rabbit Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Rabbit Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/Rabbit/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rabbit Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rabbit Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rabbitcore"
