...
{
    if(fLiteMode) return; // ignore all Rabbit related functionality
...
/*
    ...
    allow endless transaction that would bloat Rabbit and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("rabbit-privatesend");
