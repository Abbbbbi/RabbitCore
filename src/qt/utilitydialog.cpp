    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Rabbit Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Rabbit Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rabbit-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Rabbit in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an rabbittive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 RABBIT, 0.1 RABBIT, 1 RABBIT and 10 RABBIT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rabbitcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://rabbitcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Rabbit Core is shutting down...") + "<br /><br />" +
