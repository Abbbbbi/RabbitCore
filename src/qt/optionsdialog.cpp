    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RABBIT-light"), QVariant("light"));
    ui->theme->addItem(QString("RABBIT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RABBIT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RABBIT-traditional"), QVariant("trad"));
