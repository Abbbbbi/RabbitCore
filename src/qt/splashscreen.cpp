    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Rabbit Core");
    ...
    QString copyrightTextRabbit   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Rabbit Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextRabbit);
