    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Rabbit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rabbit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rabbit: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Rabbit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rabbit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rabbit Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rabbit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rabbit addresses"));
    ...
    openAction->setStatusTip(tr("Open a rabbit: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rabbit Core help message to get a list with possible Rabbit Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Rabbit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rabbit network", "", count));
}
...
{
    QString strTitle = tr("Rabbit Core"); // default title
