 ...
 *
 *   // network
 *   CRabbitNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.rabbitcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRabbitNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: RabbitNetwork
// //   -- signature requirements : Key1(User)
// class CRabbitNetworkVariable : public CGovernanceObject
// {
// private:
