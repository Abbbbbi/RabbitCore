...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RabbitNetwork") type = RabbitNetwork;
    if(strType == "RabbitNetworkVariable") type = RabbitNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RabbitNetwork) s = "RabbitNetwork";
    if(type == RabbitNetworkVariable) s = "RabbitNetworkVariable";
